...
@section('content')
    <div class="p-4 p-md-5 mb-4 bg-primary text-white rounded-3 shadow-sm">
        ...
        <p class="col-12 col-md-8 fs-6 fs-md-5">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <h6 class="text-muted small">Jenis Barang</h6>
                ...
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <a href="{{ route('inventaris.show', $barang) }}" class="btn btn-sm btn-outline-primary ms-auto">Detail</a>
                        </div>
                    </div>
                </div>
            </div>
